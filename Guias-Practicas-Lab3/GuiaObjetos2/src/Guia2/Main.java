...
import Guia2.Ej1.Autor;
import Guia2.Ej1.Libro;
import Guia2.Ej2.Cliente;
import Guia2.Ej2.Factura;
import Guia2.Ej2.ItemVenta;
import Guia2.Ej3.Cuenta;
import Guia2.Ej3.Titular;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        eJava.setCantidad(eJava.getCantidad() + 50);

        System.out.println(eJava.getA());  // getA es getAutor
